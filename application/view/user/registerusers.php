...
if (isset($_POST['submit'])) {
    if (isset($_POST['username']) && isset($_POST['password'])) {
        ...
        $registeruser = $this->model->registeruser($_POST['username'], $salted_hash, $p_salt, $_POST['email'], $_POST['firstname'], $_POST['lastname'], $_POST['securityq1'], $_POST['securitya1'], $_POST['securityq2'], $_POST['securitya2']);
