...
<div class="col-md-7 col-md-offset-3">
    <form role="form" method="post" action="<?php echo ADMINSURL; ?>/insertpage">
        ...
        <div class="form-group">
            <div class="col-sm-10">
                <input name="pSURL" type="text" class="form-control" id="field-1" placeholder="<?php echo Filtration\Core\System::translate("Enter a Page SURL"); ?>">
            </div>
        </div>
</div>
