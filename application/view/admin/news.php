            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion-test-<?php echo Filtration\Core\System::escape($news->news_id); ?>" href="#collapseOne-<?php echo Filtration\Core\System::escape($news->news_id); ?>" class="collapsed">
                            <?php echo Filtration\Core\System::escape($news->news_title); ?>
                        </a>
                    </h4>
                </div>
