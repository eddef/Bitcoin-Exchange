<div class="col-sm-6 col-sm-offset-3 ">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo Filtration\Core\System::translate("2 Factor Authentication"); ?></h3>
        ...
        <div class="panel-body">
            <form method="POST" action="<?php echo SURL; ?>user/login" role="form">
                ...
                <div class="form-group">
                    <input type="text" name="twocode" class="form-control" size="25" placeholder="<?php echo Filtration\Core\System::translate(" Authentication code "); ?>">
                    <?php echo Filtration\Core\System::translate("This is the code supplied on your mobile phone. Open Google Authenticator
